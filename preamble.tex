...
% Запрещаем переносы с короткими фрагментами вроде «останов-ку».
\setlanghyphenmins{russian}{3}{3}
...
% TikZ + pgfplots для графиков и диаграмм
\usepackage{tikz}
\usepackage{pgfplots}
\pgfplotsset{compat=1.18}
\usetikzlibrary{arrows.meta, positioning, shapes.geometric, calc, patterns, fit, backgrounds}
\usepgfplotslibrary{groupplots, statistics, polar}
...
\providecommand\addchaptertocentry[2]{}
