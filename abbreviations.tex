...
BFF & серверный слой для веб-клиента (Backend-for-Frontend)\\[0.5em]
...
RAG & генерация с~дополнением поиском\\[0.5em]
...
SAM (методология) & Successive Approximation Model (итеративная методология проектирования курсов)\\[0.5em]
SAM (рынок) & Serviceable Addressable Market (доступный рынок в~контексте рыночного анализа)\\[0.5em]
