...
Последовательность компонентов конвейера показана на рисунке~\ref{fig:ingestion-pipeline}.
...
Сценарий взаимодействия компонентов при генерации курса представлен на рисунке~\ref{fig:course-sequence}.
...
Цикл авто-актуализации показан на рисунке~\ref{fig:actualization-cycle}.

\input{figures/fig-actualization-cycle.tex}
