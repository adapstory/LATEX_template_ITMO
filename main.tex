...
\appendix
\input{appA.tex}   % А — Руководство для интервью с клиентами
\input{appB.tex}   % Б — Артефакты решенческих интервью
\input{appC.tex}   % В — Протокол внутренней и открытой апробации
\input{appD.tex}   % Г — C4-диаграммы
\input{appE.tex}   % Д — Граф агентов LangGraph
\input{appF.tex}   % Е — Промпт-шаблоны ADDIE/SAM/BD
\input{appG.tex}   % Ж — Тестовый набор данных
\input{appH.tex}   % И — Оценочные артефакты и текущие результаты
\input{appI.tex}   % К — Канва бизнес-модели и финансовая модель
\input{appJ.tex}   % Л — Матрица воспроизводимости MVP
