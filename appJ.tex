...
Численные значения в JSON-артефактах синхронизированы с
paired-прогоном B2/B4 на~19-документном корпусе; скриншоты
показывают интерфейсный контур и не заявляют завершённую внешнюю
экспертную оценку.
...
блоке показано paired-сравнение B2/B4 на~одном корпусе; дорожки B1
и B3 не используются как завершённые измерения в~этой версии работы.

\begin{figure}[p]
  \centering
  \includegraphics[width=0.98\textwidth]{figures/ui/ai-methodist-03-thesis-validation.png}
  \caption{Метрики дипломной проверки и paired-сравнение B2/B4}
